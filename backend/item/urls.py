...
from .train_classifier_views import train_classifier_status_view, train_classifier_start_view, train_classifier_stop_view
...
urlpatterns = [
    ...
    path('train_classifier/stop/', train_classifier_stop_view),
