...
def _suggest_from_similar_tags(tag_names, description, exclude_pk):
    ...
    # NotSupportedError for it (see backend.settings' DB_ENGINE toggle).
    # Filtering in Python instead, same as region_mismatch_queue's own
    # "can't express this as a portable query" reasoning — fine at this
    # app's personal-archive scale.
