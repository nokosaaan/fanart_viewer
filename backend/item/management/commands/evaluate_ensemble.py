...
takes priority, then a Danbooru people-count tag like "2girls"/
"multiple_girls" -> MULTIPLE, then 1girl+solo -> SOLO) is a direct read
of the image and is trusted on its own rather
